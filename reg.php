...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nama === '' || $email === '' || $pass === '' || $pass2 === '') {
        ...
        $chk->store_result();
        if ($chk->num_rows > 0) {
            $err = 'Email sudah terdaftar. Coba login atau pakai email lain.';
        }
        $chk->close();
    }
...
<title>Register — Rencana Liburan</title>
...
<div class="login-wrapper">
  ...
  <div class="login-hero">
    <img class="bg" src="https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=1600&q=80" alt="Mountain">
  ...
  <defs><linearGradient id="logoC" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#38bdf8"/><stop offset="100%" stop-color="#0369a1"/></linearGradient></defs>
  <rect width="100" height="100" rx="22" fill="url(#logoC)"/>
  ...
  <path d="M56 44 L74 58 L64 62 L66 48 Z" fill="#fff" opacity="0.85"/>
    ...
    <div style="position:absolute; bottom:32px; left:24px; right:24px; color:#fff;">
      <h1 style="font-size:32px; font-weight:800; line-height:1.1; margin:0 0 8px 0; text-shadow:0 2px 8px rgba(0,0,0,.4);">Mulai Rencana<br>Liburanmu Sekarang!</h1>
      <p style="font-size:13px; line-height:1.6; margin:0; color:rgba(255,255,255,.9); max-width:320px;">Buat akun untuk menyimpan rencana, menjelajahi destinasi, dan mengatur semua perjalananmu.</p>
    </div>
  </div>
  ...
  <defs><linearGradient id="logoD" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#38bdf8"/><stop offset="100%" stop-color="#0369a1"/></linearGradient></defs>
  <rect width="100" height="100" rx="22" fill="url(#logoD)"/>
  <circle cx="42" cy="48" r="14" fill="#fff"/>
  <path d="M32 42 Q22 38 18 48 Q24 46 28 50 Q22 50 20 58 Q26 54 32 56 Q30 62 34 66 Q34 58 38 54 Q36 62 40 68 Q40 60 42 54 Z" fill="#fff"/>
  <path d="M50 78 Q62 62 72 72 L82 62 L94 78 Z" fill="#fff"/>
  <ellipse cx="76" cy="52" rx="9" ry="4" fill="#fff"/>
  ...
  <path d="M56 44 L74 58 L64 62 L66 48 Z" fill="#fff" opacity="0.85"/>
      ...
      <h2 style="text-align:center; margin:20px 0 0 0; font-size:30px; font-weight:800; color:#1e293b;">Register</h2>
      <p style="text-align:center; margin:8px 0 0 0; font-size:14px; color:#64748b;">Buat akun baru untuk memulai petualanganmu.</p>
      ...
      <form method="post" style="margin-top:24px; display:flex; flex-direction:column; gap:16px;">
        ...
        <div style="position:relative;">
          <span style="position:absolute; left:16px; top:50%; transform:translateY(-50%); color:#94a3b8; pointer-events:none;">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" style="width:20px; height:20px;"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 4-7 8-7s8 3 8 7"/></svg>
          </span>
          <input type="text" name="nama" required autofocus value="<?= e($nama) ?>" placeholder="Nama Lengkap"
        ...
        <div style="position:relative;">
          ...
          <input type="email" name="email" required value="<?= e($email) ?>" placeholder="Email"
                 style="width:100%; padding:16px 16px 16px 48px; border-radius:16px; border:1px solid #e2e8f0; background:#fff; font-size:14px; color:#334155; outline:none; font-family:inherit; transition:.2s;"
                 onfocus="this.style.borderColor='#38bdf8'; this.style.boxShadow='0 0 0 4px rgba(56,189,248,.15)';"
                 onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
        </div>
        ...
        <div style="position:relative;">
          ...
          <input type="password" name="password" id="passInput" required minlength="6" placeholder="Password"
                 ...
                 onfocus="this.style.borderColor='#38bdf8'; this.style.boxShadow='0 0 0 4px rgba(56,189,248,.15)';"
                 onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
          <button type="button" onclick="togglePassword('passInput','eyeIcon1')" style="position:absolute; right:16px; top:50%; transform:translateY(-50%); background:none; border:none; color:#94a3b8; cursor:pointer; padding:0;">
            <svg id="eyeIcon1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" style="width:20px; height:20px;"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/></svg>
          </button>
        </div>
        ...
        <div style="position:relative;">
          ...
          <input type="password" name="password2" id="passInput2" required minlength="6" placeholder="Konfirmasi Password"
                 style="width:100%; padding:16px 48px 16px 48px; border-radius:16px; border:1px solid #e2e8f0; background:#fff; font-size:14px; color:#334155; outline:none; font-family:inherit; transition:.2s;"
                 onfocus="this.style.borderColor='#38bdf8'; this.style.boxShadow='0 0 0 4px rgba(56,189,248,.15)';"
                 onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none';">
          <button type="button" onclick="togglePassword('passInput2','eyeIcon2')" style="position:absolute; right:16px; top:50%; transform:translateY(-50%); background:none; border:none; color:#94a3b8; cursor:pointer; padding:0;">
            <svg id="eyeIcon2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" style="width:20px; height:20px;"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/></svg>
          </button>
        </div>
      ...
      <p style="text-align:center; font-size:14px; color:#64748b; margin:0 0 16px 0;">
        Sudah punya akun?
        <a href="login.php" style="color:#0ea5e9; font-weight:800; text-decoration:none; margin-left:4px;">Login di sini</a>
      </p>
